...
const cardData = [
  {
    ...
    description:
      "Effortlessly intergrate and manage BlockChain with our cutting edge API, designed for seamless control",
    color: "fuchsia",
  },
  {
    image: Cuboid,
    ...
    description:
      "Empower your applications with decentralized data solutions, ensuring seceurity and transparency every step",
    color: "lime",
  },
  {
    image: Cone,
    ...
    description:
      "Unlock the potential on Next-Gen smart contracts with our robust and scaleable API, taiolored for modern BlockChain needs",
    color: "cyan",
  },
  {
    image: Icosahedron,
    ...
    description:
      "Intergrate BlockChain technology seamlessly into your project, with minimal effort and maximum results",
    color: "violet",
  },
];
