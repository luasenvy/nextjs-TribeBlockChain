          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-xl lg:text-2xl text-zinc-400 mt-8">
                BlockForge provides robust and secure infrastructur to support the next generation
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="col-span-2">
              ...
              <div className="flex flex-col text-xl lg:text-2xl text-zinc-400 mt-6 gap-6">
                <p>
                  BlockForge is dedicated to support the evolution of Web3 applications by
                  delivering the necessary infrastructure and secuirty for Web3
                </p>
                <p>
                  BlockForge champions Web3 for everyone. As a decentralized BlockChain scaling
                  platform, BlockForge enables developers to create scable user-friendly Apps with
                  transaction cost ensuring robust security.
                </p>
              </div>
              <div className="flex gap-8 mt-12 items-center justify-center lg:justify-start lg:pr-2">
                <CutCornerButton>Get Started</CutCornerButton>
