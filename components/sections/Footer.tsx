...
const socialIcons = [
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="size-5">
    ...
    <footer className="py-16 bg-zinc-950">
      <div className="container">
        <div className="flex justify-between items-center">
          <div>
            <Image src={LogoImage} alt="logo img" />
          </div>
          <nav className="hidden md:flex gap-12 text-zinc-500 font-heading font-black">
            <ViewTransitionLink
              href="#"
              className="hover:text-fuchsia-500 transition-colors hover:underline hover:underline-offset-2"
            >
              Home
            </ViewTransitionLink>
            <ViewTransitionLink
        ...
        <div className="mt-12 md:mt-48 md:flex justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex gap-6">
            {socialIcons.map(({ icon, href }, iconIndex) => (
              <div
                className="inline-flex size-10 bg-zinc-800 hover:bg-fuchsia-500 rounded-full items-center justify-center"
                key={iconIndex}
              >
                <a
                  href={href}
                  target="_blank"
                  className="flex justify-center items-center w-full h-full transition-colors fill-zinc-500 hover:fill-zinc-800"
                >
                  {icon}
                </a>
              </div>
